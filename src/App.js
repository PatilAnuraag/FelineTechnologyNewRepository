...
function App() {
  ...
  return (
    ...
    <div className="App">
      <Router>
        <Header handleNav={handleNav} setWorkspaceId={setWorkspaceId} ></Header>
        <div className='wrapper'>
          <Navbar isOpen={isOpen}></Navbar>
          <div className='container-box'>
            <Routes>
              <Route path="/" element={<Platform workspaceId={workspaceId} />} />
              <Route path="/analytic" element={<Analytic />} />
              <Route path="/chat" element={<Chat />} />
              <Route path="/platform" element={() => <Platform workspaceId={workspaceId} />} />
